...
export default function ContactPage() {
  ...
  const socialMedia = [
    ...
    {
      name: 'GitHub',
      link: 'https://github.com/pratyushsawant',
    ...
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/pratyushsawant_/',
      icon: <FaInstagram className="text-2xl" />,
      description: 'Follow my visual journey and creative moments.',
      username: 'pratyushsawant_',
